...
export function ClaudeSetupCard() {
  ...
  if (state.kind === "loading") {
    return (
      <div className="flex items-center gap-2 rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-sm text-slate-600 dark:border-slate-800 dark:bg-slate-800/50 dark:text-slate-300">
  ...
  if (state.kind === "connected") {
    return (
      <div className="flex flex-wrap items-center gap-3 rounded-lg border border-emerald-200 bg-emerald-50 px-3 py-2 text-sm text-emerald-800 dark:border-emerald-900 dark:bg-emerald-950/40 dark:text-emerald-200">
    ...
    return (
      <div className="rounded-lg border border-amber-200 bg-amber-50 px-3 py-3 text-sm dark:border-amber-900 dark:bg-amber-950/40">
        ...
        <p className="mb-3 text-xs text-amber-800 dark:text-amber-300">
          ...
          <code className="rounded bg-amber-100 px-1 py-0.5 font-mono dark:bg-amber-900/60 dark:text-amber-100">
  ...
  if (state.kind === "needs-setup") {
    return (
      <div className="rounded-lg border border-slate-200 bg-white px-3 py-3 text-sm dark:border-slate-800 dark:bg-slate-800/50">
  ...
  if (state.kind === "waiting-install") {
    return (
      <div className="rounded-lg border border-blue-200 bg-blue-50 px-3 py-3 text-sm text-blue-900 dark:border-blue-900 dark:bg-blue-950/40 dark:text-blue-200">
